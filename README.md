...
* [upx](https://github.com/upx/upx) ⭐ 17,812 | 🐛 27 | 🌐 C++ | 📅 2026-08-24: 压缩可执行文件
...
* [go-musicfox](https://github.com/go-musicfox/go-musicfox) ⭐ 2,521 | 🐛 12 | 🌐 Go | 📅 2026-08-25: 在终端里听网易云音乐
...
* [botpress](https://github.com/botpress/botpress) ⭐ 14,879 | 🐛 53 | 🌐 TypeScript | 📅 2026-08-24: 聊天机器人。TS 实现的。
...
* [beancount](https://github.com/beancount/beancount) ⭐ 5,935 | 🐛 236 | 🌐 Python | 📅 2026-08-23: 复式记账语言，纯文本编辑，命令行操作，提供类似 SQL 的查询
  * [ledger](https://github.com/ledger/ledger) ⭐ 6,017 | 🐛 14 | 🌐 C++ | 📅 2026-08-22: 备选方案
...
* [SmsForwarder](https://github.com/pppscn/SmsForwarder) ⭐ 27,667 | 🐛 10 | 🌐 Kotlin | 📅 2026-08-25: 短信转发器（安卓系统）
* 临时接收手机短信
...
* [Casdoor](https://github.com/casdoor/casdoor) ⭐ 14,267 | 🐛 108 | 🌐 Go | 📅 2026-08-22: An open-source Agent-first Identity and Access Management (IAM) /LLM MCP & agent gateway and auth server with web UI supporting OpenClaw, MCP, OAuth, OIDC, SAML, CAS, LDAP, SCIM, WebAuthn, TOTP, MFA, Face ID, Google Workspace, Azure AD
...
* [scancode-toolkit](https://github.com/nexB/scancode-toolkit) ⭐ 2,612 | 🐛 1,679 | 🌐 Python | 📅 2026-08-25: detects licenses, copyrights, package manifests & dependencies and more by scanning code ... to discover and inventory open source and third-party packages used in your code.
...
* [SonarQube](https://github.com/SonarSource/sonarqube) ⭐ 10,920 | 🐛 0 | 🌐 Java | 📅 2026-08-24: 「待评估」
...
* [micro](https://github.com/micro-editor/MICRO) ⭐ 29,433 | 🐛 1,038 | 🌐 Go | 📅 2026-08-25: 学习成本低，零配置的终端编辑器
* vim
...
* [Monaco Editor](https://github.com/Microsoft/monaco-editor) ⭐ 46,582 | 🐛 848 | 🌐 JavaScript | 📅 2026-08-24: VS Code 的代码编辑器
...
* [TabNine](https://github.com/zxqfl/TabNine/) ⭐ 10,773 | 🐛 0 | 🌐 Shell | 📅 2025-09-04: 用深度学习进行自动补全。支持 VS Code, Sublime Text, Vim, Atom, Emacs
...
* bt tracker: BT 下载必须设置 tracker，否则没有速度。
  * <https://github.com/ngosang/trackerslist> ⭐ 54,965 | 🐛 13 | 📅 2026-08-24
  * <https://github.com/XIU2/TrackersListCollection> ⭐ 32,023 | 🐛 1 | 📅 2026-08-25
* <https://y2meta.app/> : Youtube 下载工具，在线服务。支持 1080p，没广告，没套路，下载速度很快
  * [youtube-dl](https://github.com/rg3/youtube-dl) ⭐ 141,018 | 🐛 4,128 | 🌐 Python | 📅 2026-02-19: 开源的视频下载工具，命令行操作
...
* [delta](https://github.com/dandavison/delta) ⭐ 31,852 | 🐛 430 | 🌐 Rust | 📅 2026-08-02: 语义化 Diff，功能丰富。Git 配置不友好。支持双列、git blame、git grep。
  * [difftastic](https://github.com/Wilfred/difftastic) ⭐ 25,816 | 🐛 298 | 🌐 Rust | 📅 2026-08-23: 基于 tree-sitter 的 diff。Git 配置不友好
...
* [pixelmatch](https://github.com/mapbox/pixelmatch) ⭐ 6,927 | 🐛 15 | 🌐 JavaScript | 📅 2026-07-07
...
* [binwalk](https://github.com/ReFirmLabs/binwalk) ⭐ 14,265 | 🐛 92 | 🌐 Rust | 📅 2026-08-11: 固件分析工具。
...
* [dasel](https://github.com/TomWright/dasel) ⭐ 8,025 | 🐛 25 | 🌐 Go | 📅 2026-08-16: JSON, TOML, YAML, XML, CSV 增删改查、格式转换工具。缺点：无法直接 put 数组。
...
* 我喜欢的面向人类的配置文件语法
  * [TOML](https://github.com/toml-lang/toml) ⭐ 20,584 | 🐛 12 | 📅 2026-07-03
...
* [yq](https://github.com/mikefarah/yq) ⭐ 15,870 | 🐛 287 | 🌐 Go | 📅 2026-08-20: 类似 jq
...
* [shellcheck](https://github.com/koalaman/shellcheck) ⭐ 39,919 | 🐛 1,139 | 🌐 Haskell | 📅 2026-08-04: linux shell script lint
* [commitlint](https://github.com/conventional-changelog/commitlint) ⭐ 18,699 | 🐛 82 | 🌐 TypeScript | 📅 2026-08-24: Lint git commit messages
* [hadolint](https://github.com/hadolint/hadolint) ⭐ 12,369 | 🐛 201 | 🌐 Haskell | 📅 2026-08-24: Dockerfile Lint <a name="commitlint"></a>
...
* [checkstyle](https://github.com/checkstyle/checkstyle) ⭐ 9,000 | 🐛 788 | 🌐 Java | 📅 2026-08-25: Java code lint
...
* [editorconfig-checker](https://github.com/editorconfig-checker/editorconfig-checker) ⭐ 634 | 🐛 36 | 🌐 Go | 📅 2026-08-23: 兼容 .editorconfig，且可忽略文件。它提供额外的配置选项 .ecrc
...
* [insomnia](https://insomnia.rest): Mock, Test & Track HTTP Requests and Responses
  * <https://github.com/Kong/insomnia-mockbin> ⭐ 2,048 | 🐛 49 | 🌐 JavaScript | 📅 2026-08-06
...
* [mkcert](https://github.com/FiloSottile/mkcert) ⭐ 59,493 | 🐛 178 | 🌐 Go | 📅 2024-08-13: 零配置生成自签名证书。默认有效时间 825 天。
* [lego](https://github.com/go-acme/lego) ⭐ 9,832 | 🐛 102 | 🌐 Go | 📅 2026-08-21: 免费证书生成工具。简单好用，文档清晰。
  * [acme.sh](https://github.com/Neilpang/acme.sh) ⭐ 47,534 | 🐛 98 | 🌐 Shell | 📅 2026-08-22: 备选方案。支持 ZeroSSL.com、Letsencrypt.org、BuyPass.com、SSL.com、Pebble strict Mode，以及其他遵循 RFC8555 的 CA。支持模式 Webroot，Standalone，Standalone tls-alp，Apach，Nginx，DNS，DNS alias，Stateless。
  * [certbot](https://github.com/certbot/certbot) ⭐ 33,211 | 🐛 187 | 🌐 Python | 📅 2026-08-21: 备选方案。letsencrypt 官方证书生成工具
...
* 其他备份工具
  * [backintime](https://github.com/bit-team/backintime) ⭐ 2,654 | 🐛 146 | 🌐 Python | 📅 2026-08-17: 备选方案
...
* [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,366 | 🐛 41 | 🌐 Python | 📅 2026-08-24: postgres 命令行客户端

* [mycli](https://github.com/dbcli/mycli) ⭐ 11,967 | 🐛 3 | 🌐 Python | 📅 2026-08-24: mysql 命令行客户端
...
* [migrate](https://github.com/golang-migrate/migrate) ⭐ 18,850 | 🐛 489 | 🌐 Go | 📅 2026-07-05: 用 Go 写的，支持 SQL，支持命令行和 Go 编程。
* [gh-ost](https://github.com/github/gh-ost) ⭐ 13,535 | 🐛 328 | 🌐 Go | 📅 2026-08-25: 与 flyway 不一样的实现方案，创建 shadow/ghost 表来作 schema migration。功能丰富。不基于 trigger，基于 bin-log。
* [flyway](https://github.com/flyway/flyway) ⭐ 10,024 | 🐛 256 | 🌐 Java | 📅 2026-08-13: 用 Java 写的，支持 SQL 和 Java 写 migration。没有 revert 概念。
...
* [buf](https://github.com/bufbuild/buf) ⭐ 11,386 | 🐛 61 | 🌐 Go | 📅 2026-08-24: .proto 管理器
...
* Matrix Server
  ...
  * [synapse](https://github.com/element-hq/synapse) ⭐ 4,554 | 🐛 2,082 | 🌐 Python | 📅 2026-08-24: Synapse: Matrix homeserver written in Python/Twisted
  * [tuwunel](https://github.com/matrix-construct/tuwunel) ⭐ 2,453 | 🐛 63 | 🌐 Rust | 📅 2026-08-24: Official successor to [conduwuit](https://github.com/girlbossceo/conduwuit) ⚠️ Archived
...
* [FIO](https://github.com/axboe/fio) ⭐ 6,343 | 🐛 236 | 🌐 C | 📅 2026-08-24: 测试硬盘 IO。开源。
* [stress-ng](https://github.com/ColinIanKing/stress-ng) ⭐ 2,746 | 🐛 2 | 🌐 C | 📅 2026-08-23: 对 CPU、内存、IO 的压力测试
...
* [Algolia](https://www.algolia.com/): 商业搜索引擎
  * [docsearch](https://github.com/algolia/docsearch) ⭐ 4,369 | 🐛 84 | 🌐 TypeScript | 📅 2026-08-24: 基于 algolia 服务的搜索框，搜索时需要请求 algolia api。
...
* [react-email](https://github.com/resend/react-email) ⭐ 19,661 | 🐛 31 | 🌐 TypeScript | 📅 2026-08-19: 用 React 构建邮件
* [docker-mailserver](https://github.com/docker-mailserver/docker-mailserver) ⭐ 18,796 | 🐛 107 | 🌐 Shell | 📅 2026-08-24: 运行在容器内的邮件服务器，无需数据库。
* [nodemailer](https://github.com/nodemailer/nodemailer) ⭐ 17,659 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-12: 邮件类库 (NodeJS)
...
* [SafeLine](https://github.com/chaitin/SafeLine) ⭐ 22,433 | 🐛 65 | 🌐 Go | 📅 2026-08-19: 中国公司做的雷池系统。UI 做的不错。
* [bunkerweb](https://github.com/bunkerity/bunkerweb) ⭐ 10,854 | 🐛 163 | 🌐 Python | 📅 2026-08-24: 「待评价」
* [ModSecurity](https://github.com/owasp-modsecurity/ModSecurity) ⭐ 9,751 | 🐛 338 | 🌐 C++ | 📅 2026-07-28: cross platform web application firewall (WAF) engine for Apache, IIS and Nginx. It has a robust event-based programming language which provides protection from a range of attacks against web applications and allows for HTTP traffic monitoring, logging and real-time analysis.
  * [OWASP CRS](https://github.com/coreruleset/coreruleset) ⭐ 3,239 | 🐛 105 | 🌐 Python | 📅 2026-08-25: ModSecurity 的防火墙规则集
...
* [Dub](https://github.com/steven-tey/dub) ⭐ 24,560 | 🐛 150 | 🌐 TypeScript | 📅 2026-08-25: 开源的短链接服务，自带访问统计。部署复杂，不支持 docker 部署。
* [YOURLS](https://github.com/YOURLS/YOURLS) ⭐ 12,170 | 🐛 48 | 🌐 PHP | 📅 2026-08-24: 备选方案
* [sink](https://github.com/ccbikai/sink) ⭐ 7,048 | 🐛 14 | 🌐 Vue | 📅 2026-08-20: 基于 Cloudflare Page 部署的短链接服务，有访问统计功能。部署简单。
* [shlink](https://github.com/shlinkio/shlink) ⭐ 5,242 | 🐛 22 | 🌐 PHP | 📅 2026-08-06: 短链服务。功能挺全。

### 评论系统

* [remark42](https://github.com/umputun/remark42) ⭐ 5,588 | 🐛 97 | 🌐 Go | 📅 2026-08-24: 评论系统
  * [waline](https://github.com/walinejs/waline) ⭐ 3,102 | 🐛 87 | 🌐 JavaScript | 📅 2026-08-24: 备选方案
...
* [Learn regex the easy way](https://github.com/ziishaned/learn-regex) ⭐ 46,087 | 🐛 65 | 📅 2025-08-25
...
* [nteract](https://github.com/nteract/nteract) ⭐ 162 | 🐛 33 | 🌐 TypeScript | 📅 2026-08-24: 基于 Jupyter 的前端跨平台项目
...
* [Vagrant](https://github.com/hashicorp/vagrant) ⭐ 27,200 | 🐛 753 | 🌐 Ruby | 📅 2026-08-03: 家用、商用方案
...
* [gomplate](https://github.com/hairyhenderson/gomplate) ⭐ 3,199 | 🐛 21 | 🌐 Go | 📅 2026-08-24: 用 Go 写的命令行工具
...
* [presenterm](https://github.com/mfontanini/presenterm) ⭐ 8,790 | 🐛 75 | 🌐 Rust | 📅 2026-05-22: 在终端播放 slide
  * [maaslalani/slides](https://github.com/maaslalani/slides) ⭐ 11,628 | 🐛 77 | 🌐 Go | 📅 2026-07-08: 备选方案
...
* [just-the-docs](https://github.com/just-the-docs/just-the-docs) ⭐ 9,137 | 🐛 98 | 🌐 SCSS | 📅 2026-08-21: 基于 Jekyll，适用于生成项目文档。搜索功能强大。
  * 缺点
    * `{:toc}` 这类语法依赖 kramdown，如果 \_config.yml 修改了 markdown 解析器，这类语法[将会失效](https://github.com/just-the-docs/just-the-docs/issues/1159) ⭐ 9,137 | 🐛 98 | 🌐 SCSS | 📅 2026-08-21。
    * 搜索栏默认[不支持中文](https://github.com/just-the-docs/just-the-docs/issues/59) ⭐ 9,137 | 🐛 98 | 🌐 SCSS | 📅 2026-08-21，它使用 [lunr.js](https://github.com/olivernn/lunr.js) ⭐ 9,200 | 🐛 130 | 🌐 JavaScript | 📅 2024-07-31，需要自己添加[语言包](https://github.com/MihaiValentin/lunr-languages) ⭐ 457 | 🐛 17 | 🌐 JavaScript | 📅 2026-08-09，得改很多东西。
    * 导航栏的编排很冗余。必须要给 markdown 文档加内容。
* [staticrypt](https://github.com/robinmoisson/staticrypt) ⭐ 8,018 | 🐛 33 | 🌐 HTML | 📅 2026-07-06: 加密静态网页，解密无需后端服务
...
* [jamstack.org](https://github.com/jamstack/jamstack.org) ⭐ 3,035 | 🐛 135 | 🌐 Nunjucks | 📅 2026-04-08
...
* [Obsidian](https://obsidian.md/): 笔记系统，纯 Markdown 文本数据本地存储，支持跨平台，插件生态好。用好插件才能发挥它的优势。
  ...
  * Obsidian 插件
    ...
    * [Style Settings](https://github.com/mgmeyers/obsidian-style-settings) ⭐ 2,453 | 🐛 40 | 🌐 TypeScript | 📅 2026-07-13: 自定义 CSS
...
* 基于 Notion 自建网站
  ...
  * [notion-sdk-js](https://github.com/makenotion/notion-sdk-js) ⭐ 5,652 | 🐛 65 | 🌐 TypeScript | 📅 2026-08-20
  * [react-notion-x](https://github.com/NotionX/react-notion-x) ⭐ 5,432 | 🐛 181 | 🌐 TypeScript | 📅 2026-08-24: 用 react 组件搭建 notion page
...
* [rehype](https://github.com/rehypejs/rehype) ⭐ 2,247 | 🐛 1 | 🌐 JavaScript | 📅 2026-06-13: HTML processor
...
* [remark](https://github.com/remarkjs/remark) ⭐ 8,983 | 🐛 11 | 🌐 JavaScript | 📅 2026-07-01: markdown processor
...
* [standard-version](https://github.com/conventional-changelog/standard-version) ⭐ 7,977 | 🐛 309 | 🌐 JavaScript | 📅 2026-07-16: Automate versioning and CHANGELOG generation, with semver.org and conventionalcommits.org (现在无人维护)
  * [semantic-release](https://github.com/semantic-release/semantic-release) ⭐ 24,003 | 🐛 405 | 🌐 JavaScript | 📅 2026-08-22: 备选方案
...
* [release-please](https://github.com/googleapis/release-please) ⭐ 7,388 | 🐛 348 | 🌐 TypeScript | 📅 2026-08-24: 结合 Github Action 自动执行：生成 Changelog，打 tag，发 Release
...
* [xxHash](https://github.com/Cyan4973/xxHash) ⭐ 11,220 | 🐛 42 | 🌐 C | 📅 2026-07-27
...
* [mihon](https://github.com/mihonapp/mihon) ⭐ 23,102 | 🐛 723 | 🌐 Kotlin | 📅 2026-08-23: 看漫画用的，需要导入插件订阅第三方源。
...
* [Wechatsync](https://github.com/wechatsync/Wechatsync) ⭐ 6,231 | 🐛 35 | 🌐 TypeScript | 📅 2026-05-27: 一键多平台同步发布文章。支持微信公众号、知乎、微博、今日头条、BiliBili、WordPress、简书、掘金、typecho 等平台
